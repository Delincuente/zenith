    ...
    <div className="space-y-4 md:space-y-8 animate-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-4">
        ...
        <button 
          ...
          className="flex items-center space-x-2 bg-blue-600 hover:bg-blue-500 text-white px-4 md:px-5 py-2 md:py-2.5 rounded-lg md:rounded-xl font-semibold transition-all shadow-lg shadow-blue-500/20 active:scale-95 text-sm md:text-base"
        >
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center lg:items-center justify-center lg:p-4">
            ...
            >
              ...
              <form onSubmit={handleCreateClient} className="space-y-6 md:space-y-8">
                <div>
                  <label className="block text-sm font-bold text-slate-400 uppercase tracking-widest mb-2.5 ml-1">Company Name</label>
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className={`block w-full pl-12 pr-4 py-4 bg-slate-800/40 border ${fieldErrors.company_name ? 'border-red-500' : 'border-slate-700/50'} rounded-2xl text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all font-medium`}
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className={`block w-full pl-12 pr-4 py-4 bg-slate-800/40 border ${fieldErrors.phone ? 'border-red-500' : 'border-slate-700/50'} rounded-2xl text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all font-medium`}
                ...
                <div className="flex space-x-4 pt-4">
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center space-x-3 py-4 md:py-5 px-6 bg-blue-600 hover:bg-blue-500 text-white font-black uppercase tracking-widest rounded-3xl md:rounded-2xl transition-all shadow-xl shadow-blue-500/20 active:scale-95 disabled:opacity-50"
                  >
                    {submitLoading ? (

...
import { X, CheckSquare, Briefcase, AlertCircle, Type, AlignLeft } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-50 flex items-center lg:items-center justify-center lg:p-4">
          ...
          >
            ...
            <form onSubmit={handleSubmit} noValidate className="space-y-6 md:space-y-8 pb-10 lg:pb-0">
              ...
              <div>
                <label className="block text-sm font-bold text-slate-400 uppercase tracking-widest mb-2.5 ml-1">Task Title</label>
              ...
              <div>
                <label className="block text-sm font-bold text-slate-400 uppercase tracking-widest mb-2.5 ml-1">Description (Optional)</label>
                <div className="relative group">
                  <span className="absolute top-4 left-4 text-slate-500 group-focus-within:text-blue-500 transition-colors">
                    <AlignLeft size={20} />
                  </span>
                  <textarea
                    value={formData.description}
                    onChange={(e) => setFormData({ ...formData, description: e.target.value })}
                    className="block w-full pl-12 pr-4 py-4 bg-slate-800/40 border border-slate-700/50 rounded-2xl text-white placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all min-h-[100px] font-medium"
